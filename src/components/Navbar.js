      ...
      <nav className="bg-neutral-900   px-2 sm:px-4 py-2.5 relative">
        <div className="container flex flex-wrap justify-between items-center ">
          ...
          <div className="flex md:order-2">
            ...
            <button
              data-collapse-toggle="mobile-menu-3 pl-12"
              type="button"
          ...
          <div
            className="hidden justify-between items-center w-80 md:flex md:w-auto md:order-1"
            id="mobile-menu-3"
          >
            ...
            <ul className="  flex flex-col mt-4 md:flex-row md:space-x-6 md:mt-0 md:text-sm md:font-medium p-2 pl-10 w-80 relative right-10">
              <li>
                <NavLink
                  to="/docs"
                  className="
