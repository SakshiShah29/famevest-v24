...
const Sidebar = () => {
    return (
        <>
			...
			<aside class="w-full h-full  mr-12" aria-label="Sidebar">
					...
					<ul class="space-y-2  ">
						<li
							...
							<NavLink to="/myprofile"
								className="flex items-center p-2  \ text-white  dark:text-white-900 hover:bg-white-900 text-2xl ">
						...
						<li
							...
							<a href="#"
								class="flex items-center p-2   text-white  dark:text-white-900 hover:bg-gray-900 text-2xl ">
								<img class="w-9 h-9 text-white transition duration-75  group-hover:text-gray-900 "
									src={watchlist} />
						...
						<li
							...
							<a href="#"
								class="flex items-center p-2   text-white  dark:text-white-900  text-2xl ">
								<img class="w-9 h-9 text-white transition duration-75  group-hover:text-gray-900 "
									src={more} alt=""/>
